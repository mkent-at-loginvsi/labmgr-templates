...
variable "session_host_count" {
  type        = number
  description = "Number of RDS session hosts to deploy into the session collection"
  default     = 2
}
